...
Finally, I have decided to enroll in the Professional Certificate in Data Science offered by [HarvardX][dscert] on [edX](https://www.edx.org). It is a nine course series, and the cool thing is that it is based in R, so it will complement what I have been learning in Python.
