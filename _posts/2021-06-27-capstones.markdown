...
There are two data sets, one for white wine (4,898 wines) and one for red wine (1,599 wines). The the goal is to create a model that estimates the subjective rating of a wine as graded by experts, using the physicochemical properties of the wine in the data set.
...
Then I had to choose a data set for the final project. I choose a credit card fraud data set I found in [Kaggle][ccfraud]. This data set includes over 280,000 credit card transactions made in September 2013 by European cardholders.
...
I received my Machilne Learning Accelerator certificate a couple days later. Again, I wholeartedly recommend this course. It was great.

After that, I moved on to HarvarX. We had to submit two capstone projects. The first one is a movie recommendation system using the [MovieLens][movielens] data set.

This data set contains 10 million ratings of more than 10,000 movies given by about 70,000 users. This was a guided project where we were provided some of the code to set up the data set and we based the recommendation system on an example we worked in the course series.
...
We were free to choose the second project. I chose to use the same credit card fraud data set, but this time coded in R. The EDS project was done in Python and I wanted to compare between the two. I am much better in Python, and I had to learn more than a few pieces to complete the project.

Here is my capstone project in [GitHub][jQScc]:

* [Credit Card Fraud][gitcc]

With these two submissions, I have now completed the HarvardX [Professional Certificate in Data Science][harvardXcert]. 

On the edX website it says the complete Certificate takes 17 months. I finished in 11. It was a fun experience. 

I will now start the process get certified in Data Science by [Data Camp][dc]. To earn [certification][dccert], one has to pass 6 timed assessments, a coding challenge, and submit a case study. Once certified, you get access to their career services team.
...
|Data Analysis in SQL (Postgree SQL) | - |
