...
---
Today I started an intro to NLP course on DataCamp. It is part of the Machine Learning Scientist with Python track I am in.
...
This is not the first time they use TF-IDF on the courses I take in DataCamp, they actually have used the method in a few courses. And the more I see it the more familiar it becomes. I guess I habe been just more used to using numbers than sentences. 
