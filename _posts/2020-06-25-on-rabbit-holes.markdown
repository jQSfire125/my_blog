...
Joking aside, I then went to the troubleshooting pages, and honestly, most of the line-commands seem to me like incantations out of a Harry Potter book. I do not understand completely what I am doing. I was searching for clues in Stack Overflow and some guy wrote:

> If you do not understand these instructions, you have NO business trying to edit your .bash_profile

So, I think I need to learn more about the command-line and what exactly a `PATH` is, how to edit the default place where a program is installed, what is the difference between the `bin` and the `usr`, and other things before I try again to wrestle control from my computer and get jekyll installed. 
